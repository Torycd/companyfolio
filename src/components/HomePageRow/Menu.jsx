...
const Menu = () => {
  const activeClass =
    " bg-blue-800 hover:bg-blue-700 text-white text-center md:text-left px-6 py-2";
  const navClass = "px-6 py-2 text-center md:text-left";
  return (
    <div className="min-h-screen my-24">
      <div className="flex flex-col md:flex-row mb-10 justify-between">
        ...
        <div className="flex self-center items-center">
          <ul className="bg-gray-200 text-xl p-2 flex  flex-col md:flex-row space-x-2 text-gray-700">
            <NavLink
              to="/"
