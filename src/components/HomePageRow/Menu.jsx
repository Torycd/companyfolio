...
const Menu = () => {
  ...
  const navClass = "px-6 py-2 ";
  return (
    <div className="min-h-screen my-24">
      <div className="flex justify-between">
        <div className="flex text-gray-800 mb-10 items-center md:text-left z-10 text-center text-nowrap font-bold leading-snug text-3xl xl:text-5xl">
          <h2>Checkout our</h2>
