    ...
    <div className="mt-20 bg-gray-200 lg:px-64 md:px-24 sm:px-10 px-4 py-20 text-gray-500">
      <div className="flex flex-col md:flex-row md:justify-between md:gap-10">
        ...
        <div className="">
          ...
          <div className="w-full h-28 md:h-12 flex flex-col md:flex-row gap-4 md:gap-0 ">
            <input
            ...
            />
            <button className="h-full w-100 md:w-[35%] rounded-lg md:rounded-none md:rounded-br-lg md:rounded-tr-lg text-white bg-blue-700 hover:bg-blue-800 transition duration-300">
              Subscribe
            </button>
          </div>
        </div>
